...
if choice=="1":
    ...
    print("Enter 1 to use your own key(should be 16 characters long), 2 for using a randomly generated key",end="")
    ans=input(":")
    if (ans=='1'):
        key = input("key:")
    else:
    ...
    output_image_path=input("Enter name or path for output image (with .png extension):")
